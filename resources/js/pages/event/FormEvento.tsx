    ...
    return (
        <>
            ...
            <div className="fixed z-[51] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2
                ...
                <div className="h-1.5 w-full bg-gradient-to-r from-violet-500 via-purple-500 to-fuchsia-600 sticky top-0 z-20" />
                    ...
                    <div className="space-y-4">
                        <Field label="Imagen del evento" req={!isEdit} error={errs.image_evento}>
                            <div
                                ...
                                className="w-full aspect-video rounded-xl border-2 border-dashed border-zinc-300 dark:border-zinc-700 flex items-center justify-center overflow-hidden cursor-pointer hover:border-violet-400 transition-colors bg-zinc-50 dark:bg-zinc-800/50"
                            >
                                {imgPreview
                            ...
                            <div className="space-y-1.5">
                                <button type="button" onClick={() => setEstadoModo('automatico')}
                                    className={`w-full flex items-center justify-between px-3 py-2.5 rounded-xl border-2 text-xs font-bold cursor-pointer transition-all
                                        ${estadoModo === 'automatico' ? 'border-violet-400 bg-violet-50 dark:bg-violet-950/30 dark:border-violet-600 text-violet-700 dark:text-violet-300' : 'border-zinc-200 dark:border-zinc-700 text-zinc-500 hover:border-zinc-300'}`}>
                ...
                <div className="sticky bottom-0 flex items-center justify-end gap-3 px-6 py-4 border-t border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950">
                    ...
                    <button onClick={submit} disabled={saving}
                        className="px-5 py-2 rounded-xl bg-violet-600 hover:bg-violet-700 text-white text-sm font-bold cursor-pointer disabled:opacity-60 flex items-center gap-2">
